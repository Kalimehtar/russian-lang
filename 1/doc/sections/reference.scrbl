...
@defproc[#:kind "функция" (метка-времени [год целое?] [месяц целое?]
         ...
         [зона (один-из целое? #,(elem (racketvalfont "ложь")))])
         метка-времени?]{
Метка времени SQL. Селекторы @racket[год-метки-времени],
@racket[месяц-метки-времени], @racket[день-метки-времени],
@racket[час-метки-времени], @racket[минута-метки-времени],
@racket[секунда-метки-времени], @racket[наносекунда-метки-времени],
@racket[зона-метки-времени].}
