...
@defproc[#:kind "функция" (дата [год целое?] [месяц целое?] [день целое?])
         дата?]{
...
Структура даты модуля @racketidfont{дата}: год, месяц, день, час, минута,
секунда, наносекунда, временная зона и другие поля.}
