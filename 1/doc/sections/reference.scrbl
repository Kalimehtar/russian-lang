...
@defproc[#:kind "функция" (подключение? [значение любой]) логический?]{
...
@defproc[#:kind "функция" (система-бд? [значение любой]) логический?]{
...
@defproc[#:kind "функция" (запрос? [значение любой]) логический?]{
...
@defproc[#:kind "функция" (нуль? [значение любой]) логический?]{
Истина, если @racket[значение] --- SQL NULL (@racket[нуль]). Это не
@racket[пусто].}
...
@defproc[#:kind "функция" (дата? [значение любой]) логический?]{
...
@defproc[#:kind "функция" (время? [значение любой]) логический?]{
...
@defproc[#:kind "функция" (метка-времени? [значение любой]) логический?]{
...
@defproc[#:kind "функция" (интервал? [значение любой]) логический?]{
