...
@racketidfont{холст}, @racketidfont{фон}, @racketidfont{отрисоватать-немедленно}.
...
@racketidfont{последняя-позиция}, @racketidfont{первый-кусок}.
...
Реализует @racket[редактор<%>]. Текстовый документ.

Аргументы: @racketidfont{межстрочный-промежуток} (1.0),
@racketidfont{автоматический-перенос} (по умолчанию @racketvalfont{ложь}).

Дополнительно к @racket[редактор<%>]: @racketidfont{вставить}
(строка, кусок или число вставок; можно указать начало, конец,
прокрутку и объединение), @racketidfont{очистить},
@racketidfont{только-просмотр}, @racketidfont{найти-позицию},
@racketidfont{найти-кусок} с направлением @racket['перед-или-пусто],
@racket['перед], @racket['после], @racket['после-или-пусто],
@racketidfont{изменить-стиль}, @racketidfont{данные-куска},
@racketidfont{обработчик-щелчка}, @racketidfont{последняя-позиция}.

События: @racketidfont{после-вставки}, @racketidfont{после-объединения-кусков},
@racketidfont{можно-менять-стиль?} (по умолчанию @racketvalfont{истина}).}
