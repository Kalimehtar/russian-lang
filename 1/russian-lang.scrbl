 ...
 (eval:alts
  (eval:no-prompt
   (unsyntax (elem (racket больше-ответов) (hspace 1) (racket запрос) (hspace 1) (racket =)
                   ...
                   (linebreak) (hspace 4) (racket строка-начинается-с?) "("
                   (racket запрос) (hspace 1) (racket "Привет") ")" (hspace 1) (racket "Привет!")
                   (linebreak) (hspace 4) (racket строка-начинается-с?) "("
                   (racket запрос) (hspace 1) (racket "Пока") ")" (hspace 1) (racket "Пока!")
                   (linebreak) (hspace 4) (racket строка-заканчивается-на?) "("
                   (racket запрос) (hspace 1) (racket "?") ")" (hspace 1) (racket "Я не знаю.")
...
@defform*[#:kind "синтаксис" #:id если
          ((если слова-условия ... тогда команда ... иначе команда ...)
           ...
           (если (условие команда ... выражение) ...)
           (если (условие команда ... выражение) ... (иначе команда ... выражение)))]{
 Выполняет выражения по условиям. Если команда создаёт переменную, то эта переменная
имеет область видимости только внутри блока с условием.}
