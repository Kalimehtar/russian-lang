...
Если надо, чтобы операция оставалась аргументом, то пишите её как список из точки и операции. Например,
если надо написать @racket[(list + 3)], то можно написать
@codeblock{
#!1
list (. +) 3
}
...
(eval:alts (unsyntax (elem (racketvalfont "кусок строка =\n    ") (racket подстрока) (racketvalfont " строка 0 часть"))) (void))
