...
Windows, модуль @racketidfont{графический-интерфейс/область-уведомлений}
...
Базовый класс: @racket[объект-графического-интерфейса%].
Иконка в области уведомлений Windows. Подключается отдельно:
@racketidfont{графический-интерфейс/область-уведомлений}.
}
...
@defproc[#:kind "функция" (загрузить-иконку [путь строка?])
         любой]{
Загружает файл @filepath{.ico} и возвращает указатель на объект
иконки для аргумента @racket[иконка].}
