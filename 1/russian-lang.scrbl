...
Функция @racket[записать] выводит символ без апострофа. Функция @racket[вывести]
выводит имя символа как строку.

@examples[#:label "Примеры:"
   (eval:alts
    (unsyntax (elem (racket записать 'символ)
   ...
   (eval:alts
    ...
    (void))
   (eval:alts
    (unsyntax (elem (racket записать '|6|)
...
Функции @racket[записать] и @racket[вывести] печатают пары и списки без начального апострофа.
Вывод этих функция отличается только тем, как они выводят элементы списков.

@examples[#:label "Примеры:"
   (eval:alts
    (unsyntax (elem (racket записать $ 1 : 2)
   ...
   (eval:alts
    ...
    (void))
   (eval:alts
    (unsyntax (elem (racket записать $ список 1 2 "3")
...
Так как @racket[разборчивая-рыба%] была определена без своих аргументов инициализации, то аругменты,
переданные в функции @racket[объект] отправляются дальше в класс @racket[рыба%]
при вызове @racket[базовый-объект].

Можно передать аргменты базовому классу явным образом:
