...
@subsubsection[#:tag "ref-список<%>"]{@racket[список<%>]}
...
@subsubsection[#:tag "ref-буфер-обмена<%>"]{@racket[буфер-обмена<%>]}
...
@subsubsection[#:tag "ref-область-уведомлений%"]{@racket[область-уведомлений%]}
...
@subsubsection[#:tag "ref-уведомление"]{@racket[уведомление]}
