...
Значение "" является псевдонимом для региональных настроек операционной системы и является
значением по умолчанию. Значение "C" всегда доступно и для него результат совпадает с тем,
который получен при значении @racketvalfont{ложь}, для литер с кодами от 0 до 127
