...
Синтаксис Адины не определяется напрямуй в терминах потоков знаков. Вместо это
...
@defproc[#:kind "функция" (символ? [аргумент любой])
         логический?]{Возвращает истину, если @racket[аргумент] является символом.}
...
@defproc[#:kind "функция" (пустой? [аргумент любой])
         логический?]{Возвращает истину, если @racket[аргумент] является пустым списком.}
...
@defproc[#:kind "функция" (соответствие? [аргумент любой])
         логический?]{Возвращает истину, если @racket[аргумент] является соответствием.}
