...
Окно верхнего уровня (обёртка над @racketidfont{frame%}).
Аргументы инициализации: @racketidfont{заголовок} (строка, по умолчанию пустая),
@racketidfont{ширина} и @racketidfont{высота} (число или @racket[ложь] --- размер по содержимому),
...
Расширяет @racket[вместилище-окно<%>].
...
@racket[группа%] (@racketidfont{pane%}) только раскладывает детей и сама не рисуется.
@racket[панель%] (@racketidfont{panel%}) --- видимый контейнер.
Горизонтальные и вертикальные варианты задают направление раскладки.

@defthing[#:kind "класс" группа% любой]{
Контейнер без собственной рамки. Реализует @racket[вместилище<%>] и @racket[подобласть<%>].
...
Видимая панель (@racket[вместилище-окно<%>] и @racket[подокно<%>]).
Дополнительный аргумент @racketidfont{стиль} --- список символов стиля Racket GUI.}

@defthing[#:kind "класс" горизонтальная-панель% любой]{
Горизонтальная панель. Метод @racketidfont{ориентация} читает и задаёт направление.}

@defthing[#:kind "класс" вертикальная-панель% любой]{
Вертикальная панель с тем же методом @racketidfont{ориентация}.}

@defthing[#:kind "интерфейс" вместилище<%> любой]{
@racketidfont{элементы}, @racketidfont{добавить-элемент},
...
Панель-таблица из модуля @racketidfont{графический-интерфейс/табличная-панель}.
...
Кнопка. Аргументы: @racketidfont{заголовок}, @racketidfont{родитель},
...
Статический текст или картинка-подпись (@racketidfont{message%}).
...
@racketidfont{растягивается-ширина} (по умолчанию истина).
Метод @racketidfont{значение} читает и записывает текст.}

@defthing[#:kind "класс" поле-даты% любой]{
Поле ввода даты из @racketidfont{графический-интерфейс/поле-даты}
(отдельное подключение). Наследует @racket[текстовое-поле%].}

@defthing[#:kind "класс" строка-меню% любой]{
Строка меню окна. Аргумент @racketidfont{родитель} --- главное окно или диалог.}
...
Пункт меню. Аргументы: @racketidfont{родитель}, @racketidfont{заголовок},
...
Описание шрифта. Аргументы инициализации:
@racketidfont{размер} (12), @racketidfont{семейство} (@racket['default]),
...
Шрифт, совпадающий со стандартным шрифтом элементов управления Racket.}
...
@defproc[#:kind "функция" (на-основе-шрифта [шрифт шрифт%]
         ...
         шрифт%]{
Новый шрифт, копирующий @racket[шрифт]. Не указанные ключевые аргументы берутся
из исходного шрифта.}

@defthing[#:kind "класс" событие% любой]{
Базовое событие с методом @racketidfont{время}.
...
Холст для рисования. Аргумент @racketidfont{обработка} --- функция от картины и холста,
...
Холст редактора. Аргумент @racketidfont{редактор} --- объект @racket[текст%] или другой
@racket[редактор<%>].}

@defthing[#:kind "класс" текст% любой]{
Текстовый редактор. Аргументы: @racketidfont{межстрочный-промежуток} (1.0),
...
Фрагмент документа редактора. Методы: @racketidfont{следующий},
...
Текстовый кусок. Аргумент @racketidfont{содержимое} --- строка или начальный размер.}

@defthing[#:kind "класс" кусок-с-изображением% любой]{
Кусок-картинка. Метод @racketidfont{изображение} читает и задаёт растр.}

@defthing[#:kind "класс" кусок-с-редактором% любой]{
Вложенный редактор. Аргументы @racketidfont{редактор} и @racketidfont{есть-граница}.}
...
@tabular[#:sep @hspace[1]
         (list (list @bold{Модуль} @bold{Что экспортирует})
               ...
               (list @racketidfont{графический-интерфейс/шрифт}
                     @elem{@racket[шрифт%], @racket[шрифт-элемента-управления], @racket[на-основе-шрифта]})
...
Использование @racket[этот], @racket[базовый] и @racket[производный]
