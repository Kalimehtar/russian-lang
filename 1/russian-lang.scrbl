...
собраны в справочнике: @secref["gui-reference"].
...
@tabular[#:sep @hspace[1]
         (list (list @bold{Модуль} @bold{Что экспортирует})
               (list @racketidfont{графический-интерфейс}
                     "сводка: окна, виджеты, меню, шрифт, редактор, куски")
...
@defform[#:kind "оператор" (аргументы ==> выражение)
         #:grammar
...
@racketidfont{графический-интерфейс/кнопка} или
@racketidfont{графический-интерфейс/табличная-панель}.
Модуль сам подключает @racket[класс]. Объекты создаются формой @racket[объект].

Многие методы читают значение без аргументов и записывают его, если аргумент
передан: так устроены @racketidfont{заголовок}, @racketidfont{значение},
@racketidfont{минимальная-ширина}, @racketidfont{выравнивание}.
События — методы с приставкой @racketidfont{при-} или с вопросом
(@racketidfont{можно-закрыть?}); в базовых классах они ничего не делают
или возвращают значение по умолчанию и их можно переопределить.

@subsubsection[#:tag "gui-ref-interfaces"]{Интерфейсы}

@defthing[#:kind "интерфейс" область<%> любой]{
Общие размеры и растягивание. Методы:

@itemlist[
 @item{@racketidfont{родитель} --- вместилище, в котором лежит область;}
 @item{@racketidfont{главное-окно} --- окно верхнего уровня;}
 @item{@racketidfont{минимальная-ширина} и @racketidfont{минимальная-высота}
  --- чтение и запись минимальных размеров;}
 @item{@racketidfont{минимальные-размеры-вывода} --- пара графических минимумов;}
 @item{@racketidfont{растягивается-ширина} и @racketidfont{растягивается-высота}
  --- можно ли растягивать область.}
]
...
Методы показа и активности: @racketidfont{показать}, @racketidfont{показано?},
@racketidfont{включить}, @racketidfont{включено?}, @racketidfont{есть-фокус?},
@racketidfont{сфокусировать}.

Геометрия: @racketidfont{ширина}, @racketidfont{высота}, @racketidfont{лево},
@racketidfont{верх}, @racketidfont{размеры}, @racketidfont{внутренние-размеры},
@racketidfont{окно->экран}, @racketidfont{экран->окно},
@racketidfont{переместить-курсор}.

Прочее: @racketidfont{заголовок} (чтение и запись), @racketidfont{курсор},
@racketidfont{принимать-файлы}, @racketidfont{контекстное-меню},
@racketidfont{указатель}, @racketidfont{обновить},
@racketidfont{режим-колеса-мыши} --- @racket['по-одному], @racket['по-целым]
или @racket['сразу].

События (по умолчанию ничего не делают; клавиша и мышь элемента возвращают
@racketvalfont{ложь}): @racketidfont{при-получении-файла},
@racketidfont{при-изменении-фокуса}, @racketidfont{при-перемещении},
@racketidfont{при-изменении-размера},
@racketidfont{при-получении-элементом-клавиши},
@racketidfont{при-получении-элементом-события},
@racketidfont{при-изменении-фокуса-элемента},
@racketidfont{при-активации-содержащего-окна},
@racketidfont{при-включении-содержащего-окна},
@racketidfont{при-показывании-содержащего-окна}.

Дополнительный аргумент инициализации: @racketidfont{включен}
(по умолчанию @racketvalfont{истина}).}

@defthing[#:kind "интерфейс" подобласть<%> любой]{
Расширяет @racket[область<%>]. Отступы внутри вместилища:
@racketidfont{горизонтальные-поля} и @racketidfont{вертикальные-поля}
(чтение и запись; у элементов управления по умолчанию 2, иначе 0).}

@defthing[#:kind "интерфейс" подокно<%> любой]{
Одновременно @racket[окно<%>] и @racket[подобласть<%>].
Метод @racketidfont{родитель} читает родителя и может сменить его.}

@defthing[#:kind "интерфейс" вместилище<%> любой]{
Расширяет @racket[область<%>]. Контейнер дочерних элементов.

Методы: @racketidfont{элементы} --- список детей;
@racketidfont{добавить-элемент} и @racketidfont{удалить-элемент};
@racketidfont{изменить-элементы} --- функция от списка детей, возвращает
новый список;
@racketidfont{начать-изменения} и @racketidfont{закончить-изменения} ---
пакет обновлений раскладки;
@racketidfont{пересчитать-положения}, @racketidfont{положения-изменены};
@racketidfont{граница} и @racketidfont{интервал} (чтение и запись, по умолчанию 0);
@racketidfont{выравнивание} читает и задаёт пару символов по горизонтали
(@racket['лево], @racket['центр], @racket['право]) и вертикали
(@racket['верх], @racket['центр], @racket['низ]);
@racketidfont{размер-вместилища} и @racketidfont{разместить-элементы} ---
раскладка;
@racketidfont{после-добавления-элемента} --- событие после появления ребёнка.

Аргумент инициализации @racketidfont{выравнивание} --- список из двух символов.}

@defthing[#:kind "интерфейс" вместилище-окно<%> любой]{
Одновременно @racket[вместилище<%>] и @racket[окно<%>].}

@defthing[#:kind "интерфейс" главное-окно<%> любой]{
Расширяет @racket[вместилище-окно<%>]. Окно верхнего уровня.

Методы: @racketidfont{в-центр} с направлением @racket['оба],
@racket['по-горизонтали] или @racket['по-вертикали];
@racketidfont{переместить}, @racketidfont{установить-размер};
@racketidfont{пространство-событий}, @racketidfont{объект-в-фокусе},
@racketidfont{окно-в-фокусе}, @racketidfont{объект-для-редактирования},
@racketidfont{окно-для-редактирования};
@racketidfont{установить-иконку} с вариантом @racket['маленькую],
@racket['большую] или @racket['обе].

События: @racketidfont{можно-закрыть?} (по умолчанию @racketvalfont{истина}),
@racketidfont{можно-выйти?} (по умолчанию вызывает @racketidfont{можно-закрыть?}),
@racketidfont{при-активации}, @racketidfont{при-закрытии},
@racketidfont{при-выходе}, @racketidfont{при-получении-сообщения},
@racketidfont{при-изменении-дисплея}, @racketidfont{при-получении-клавиши}
(по умолчанию @racketvalfont{ложь}).}

@defthing[#:kind "интерфейс" элемент-управления<%> любой]{
Расширяет @racket[подокно<%>]. Типичный элемент на панели.
Метод @racketidfont{команда} передаёт событие элементу.
По умолчанию не растягивается; аргументы @racketidfont{шрифт}
(по умолчанию @racket[шрифт-элемента-управления]) и @racketidfont{стиль}
(список символов; @racket['скрытая] --- элемент создан, но не показан).}

@defthing[#:kind "интерфейс" картина<%> любой]{
Расширяет @racket[подокно<%>]. Холст или поле редактора.

Методы: @racketidfont{холст}, @racketidfont{фон} (чтение и запись),
@racketidfont{отрисовать-немедленно},
@racketidfont{приостановить-отрисовку} и @racketidfont{продолжить-отрисовку},
@racketidfont{принимать-фокус-табом},
@racketidfont{минимальная-ширина-холста} и @racketidfont{минимальная-высота-холста}.

События (по умолчанию @racketvalfont{ложь}): @racketidfont{при-получении-клавиши},
@racketidfont{при-получении-события}, @racketidfont{при-отрисовке},
@racketidfont{при-входе-табом}.}

@defthing[#:kind "интерфейс" редактор<%> любой]{
Документ текстового редактора. Методы: @racketidfont{добавить-картину},
@racketidfont{добавить-отменятель},
@racketidfont{начать-последовательность-редактирования} и
@racketidfont{закончить-последовательность-редактирования},
@racketidfont{команды-редактора} (чтение и запись набора команд),
@racketidfont{первый-кусок}, @racketidfont{вставить-из-буфера},
@racketidfont{размеры}.

События: @racketidfont{при-получении-события},
@racketidfont{при-получении-необработанного-события}
(по умолчанию @racketvalfont{истина}),
@racketidfont{при-изменении-размера},
@racketidfont{при-начале-последовательности-редактировании}.}

@defthing[#:kind "интерфейс" пункт-меню<%> любой]{
@racketidfont{родитель}, @racketidfont{удалить}, @racketidfont{восстановить},
@racketidfont{удалён?}.}

@defthing[#:kind "интерфейс" пункт-меню-с-заголовком<%> любой]{
Расширяет @racket[пункт-меню<%>]: @racketidfont{заголовок},
@racketidfont{включить}, @racketidfont{включён?}, @racketidfont{строка-помощи}.}
...
Аргументы инициализации: @racketidfont{заголовок} (строка, по умолчанию пустая),
@racketidfont{ширина} и @racketidfont{высота} (число или @racketvalfont{ложь} ---
размер по содержимому), плюс аргументы вместилища-окна
(@racketidfont{родитель} необязателен, выравнивание по умолчанию
@racket['(центр верх)]).

Дополнительно к методам @racket[главное-окно<%>]:
@racketidfont{создать-строку-состояния} и @racketidfont{показать-состояние}.}

@defthing[#:kind "класс" диалог% любой]{
Реализует @racket[главное-окно<%>]. Модальное или вспомогательное окно.
Те же аргументы инициализации, что у @racket[главное-окно%].}

@subsubsection[#:tag "gui-ref-layout"]{Вместилища}

@defthing[#:kind "класс" группа% любой]{
Реализует @racket[вместилище<%>] и @racket[подобласть<%>].
Контейнер без собственной рамки: только раскладывает детей.
Выравнивание по умолчанию @racket['(центр центр)].}
...
Реализует @racket[вместилище-окно<%>] и @racket[подокно<%>].
Видимый контейнер. Дополнительный аргумент @racketidfont{стиль} ---
список символов стиля (по умолчанию пустой).
Выравнивание по умолчанию @racket['(центр центр)].}

@defthing[#:kind "класс" горизонтальная-панель% любой]{
Наследует @racket[панель%]. Дети слева направо.
Выравнивание по умолчанию @racket['(лево центр)].
Метод @racketidfont{ориентация} читает и задаёт направление раскладки.}
...
@racketidfont{графический-интерфейс/табличная-панель}.
Дети в сетке рядов и колонок.

Аргументы: @racketidfont{измерения} --- список @racket['(ряды колонки)],
по умолчанию @racket['(1 1)];
@racketidfont{заполнять} --- @racket['ряд] или @racket['колонку],
по умолчанию @racket['ряд];
@racketidfont{колонки-растягиваются} и @racketidfont{ряды-растягиваются} ---
@racket['любая] или @racket['каждая], по умолчанию @racket['любая].
...
Реализует @racket[элемент-управления<%>].

Аргументы: @racketidfont{заголовок} (обязателен), @racketidfont{родитель},
@racketidfont{команда} --- функция от кнопки и события (по умолчанию ничего
не делает), @racketidfont{шрифт}, @racketidfont{стиль}
(@racket['граница], @racket['многострочная], @racket['скрытая]),
размеры и растягивание (по умолчанию не растягивается).}

@defthing[#:kind "класс" надпись% любой]{
Реализует @racket[элемент-управления<%>]. Статический текст или картинка-подпись.

Аргументы: @racketidfont{заголовок} (строка или изображение, обязателен),
@racketidfont{цвет} (по умолчанию @racketvalfont{ложь}),
@racketidfont{размер-по-заголовку} (по умолчанию @racketvalfont{ложь}).
Методы @racketidfont{цвет} и @racketidfont{размер-по-заголовку}
читают и меняют эти свойства.}

@defthing[#:kind "класс" текстовое-поле% любой]{
Реализует @racket[элемент-управления<%>]. Однострочное или многострочное поле.

Аргументы: @racketidfont{заголовок} (по умолчанию @racketvalfont{ложь}),
@racketidfont{значение} --- начальная строка (по умолчанию пустая),
@racketidfont{при-изменении} --- функция от поля и события управления
...
Поле ввода даты с теми же аргументами, что у текстового поля.}

@defthing[#:kind "класс" строка-меню% любой]{
Строка меню окна. Аргумент @racketidfont{родитель} --- @racket[главное-окно%]
или @racket[диалог%].}

@defthing[#:kind "класс" меню% любой]{
Выпадающее меню. Аргументы @racketidfont{родитель} и @racketidfont{заголовок}
обязательны.}

@defthing[#:kind "класс" пункт-меню% любой]{
Реализует @racket[пункт-меню<%>] и @racket[пункт-меню-с-заголовком<%>].
Аргументы: @racketidfont{родитель}, @racketidfont{заголовок},
@racketidfont{действие} --- функция, вызываемая при выборе пункта.}
...
@racketidfont{семейство}, @racketidfont{имя} (по умолчанию @racketvalfont{ложь}),
...
@racket['сверхтяжёлая];
@racketidfont{подчёркнутый?};
@racketidfont{сглаживание} --- @racket['стандартное], @racket['частичное],
@racket['полное], @racket['отсутствует];
@racketidfont{размер-в-пикселях?}, @racketidfont{округлять-метрики?}
(по умолчанию @racketvalfont{истина}), @racketidfont{свойства} (соответствие).

Методы с теми же именами читают параметры. @racketidfont{есть-литера?}
проверяет, есть ли начертание литеры (второй аргумент --- для заголовка окна).}

@defthing[#:kind "значение" шрифт-элемента-управления шрифт%]{
Стандартный шрифт элементов управления.}
...
Базовое событие. Аргумент и метод @racketidfont{время} --- метка времени
(чтение и запись).}

При доставке в методы окна и элементов событие мыши, клавиши или управления
обёртывается. У события мыши: @racketidfont{тип}
(@racket['вход], @racket['выход], @racket['левая-нажата],
@racket['левая-отпущена], @racket['средняя-нажата],
@racket['средняя-отпущена], @racket['правая-нажата],
@racket['правая-отпущена], @racket['движение]),
@racketidfont{лево}, @racketidfont{верх},
@racketidfont{нажата-кнопка?} и @racketidfont{отпущена-кнопка?}
с аргументом @racket['левая], @racket['правая], @racket['средняя]
или @racket['любая].
У события клавиши --- @racketidfont{клавиша}.
У события управления @racketidfont{тип} бывает @racket['кнопка],
...
@defthing[#:kind "класс" картина% любой]{
Реализует @racket[картина<%>]. Холст для рисования.

Аргументы: @racketidfont{заголовок} (по умолчанию @racketvalfont{ложь}),
@racketidfont{стиль} (пустой список), @racketidfont{обработка} ---
функция от картины и холста, вызываемая при перерисовке
(по умолчанию ничего не делает), плюс аргументы подокна.}

@defthing[#:kind "класс" поле-редактора% любой]{
Реализует @racket[картина<%>]. Холст, показывающий редактор.

Аргументы как у картины, вместо обработки --- @racketidfont{редактор}
(объект @racket[текст%] или другой @racket[редактор<%>],
по умолчанию @racketvalfont{ложь}).}

@defthing[#:kind "класс" текст% любой]{
Реализует @racket[редактор<%>]. Обычный текстовый документ. На экране его
показывают через @racket[поле-редактора%] или другую картину.

Аргументы инициализации:
@racketidfont{межстрочный-промежуток} --- дополнительный промежуток между
строками при показе (входит в сообщаемую высоту строки), по умолчанию 1.0;
@racketidfont{автоматический-перенос} --- если не @racketvalfont{ложь},
включается перенос длинных строк, по умолчанию @racketvalfont{ложь}.
Для нового документа создаются свой набор команд и свой список стилей.

Методы @racket[редактор<%>] тоже доступны у объекта. Ниже --- методы
самого @racket[текст%] (включая события).

@itemlist[

 @item{@racketidfont{вставить} --- вставляет строку, кусок или литеру.
  Варианты вызова: только элемент; элемент и начало; элемент, начало и
  конец; те же аргументы плюс прокрутка; те же плюс объединение;
  количество, элемент, начало, конец, прокрутка и объединение.

  Если указано начало, вставка идёт в эту позицию. Иначе берётся начало
  текущего выделения. Если выделена область, вставляемое значение
  заменяет её; начало и конец выделения сдвигаются к концу вставки.

  Если конец не равен той же позиции, что начало, вставка заменяет
  область от начала до конца, и выделение остаётся в конце вставленного.
  Иначе, если позиция вставки не позже начала или конца выделения,
  эти границы сдвигаются на длину вставленного.

  Если прокрутка не @racketvalfont{ложь} и начало совпадает с началом
  текущего выделения, показ прокручивается к новой позиции выделения.

  Если задано количество, вставляются только первые столько литер
  строки. Кусок нельзя вставить в несколько документов или дважды в
  один: при вставке его стиль переводится в список стилей документа.

  Если объединение не @racketvalfont{ложь} (или вставляется литера),
  соседние литеры, которые должны рисоваться как один знак, включаются
  во вставку, чтобы знак не разорвался по разным кускам.}

 @item{@racketidfont{очистить} --- удаляет всё содержимое документа.}

 @item{@racketidfont{только-просмотр} --- с аргументом запирает документ
  от любых изменений, если значение не @racketvalfont{ложь}, и снимает
  запрет, если @racketvalfont{ложь}. Запираются не только правки
  пользователя, но и программные.}

 @item{@racketidfont{найти-позицию} --- по координатам @racketidfont{лево}
  и @racketidfont{верх} в документе возвращает позицию в этом месте.}

 @item{@racketidfont{найти-кусок} --- кусок в заданной позиции или
  @racketvalfont{ложь}, если подходящего куска нет. Если позиция лежит
  между кусками, направление выбирает, какой вернуть:
  @racket['перед-или-пусто] --- кусок перед позицией или
  @racketvalfont{ложь} в начале документа;
  @racket['перед] --- кусок перед позицией или первый кусок в начале;
  @racket['после] --- кусок после позиции или последний в конце;
  @racket['после-или-пусто] --- кусок после позиции или
  @racketvalfont{ложь} в конце документа и дальше.}

 @item{@racketidfont{изменить-стиль} --- меняет стиль участка, применяя
  @racket[отклонение-стиля%] или устанавливая @racket[стиль%]. Аргументы:
  стиль или отклонение (по умолчанию @racketvalfont{ложь}), начало и
  конец участка (по умолчанию --- текущее выделение), считать-изменением
  (по умолчанию @racketvalfont{истина}).

  Если начало и конец не заданы явно, меняется текущее выделение.
  Если задано только начало, стиль меняется от него до конца выделения.
  Если считать-изменением --- @racketvalfont{ложь}, документ не
  помечается изменённым.

  Чтобы сменить стиль у многих кусков сразу, лучше передать готовый
  @racket[стиль%], а не отклонение: иначе отклонение приходится
  переводить в стиль для каждого куска.}

 @item{@racketidfont{данные-куска} --- без второго аргумента возвращает
  дополнительные данные куска или @racketvalfont{ложь}, если данных нет.
  С куском и данными записывает эти данные (например, положение куска).}

 @item{@racketidfont{обработчик-щелчка} --- ставит обработчик на участок
  от начала до конца. Аргументы: начало, конец, функция, отметка
  (по умолчанию @racketvalfont{ложь}), при-нажатии?
  (по умолчанию @racketvalfont{ложь}). Если на пересекающийся участок
  уже был обработчик, новый имеет преимущество.

  Функция вызывается, когда пользователь выбирает участок: ей передаются
  документ и границы участка. Отметка --- отклонение стиля, которое
  применяется, пока кнопка мыши удерживается над участком; если
  @racketvalfont{ложь}, начертание при выборе не меняется. Если
  при-нажатии? не @racketvalfont{ложь}, функция вызывается сразу при
  нажатии, а не при отпускании; отметка тогда не используется.}

 @item{@racketidfont{последняя-позиция} --- последняя позиция выделения
  в документе; она же равна числу элементов документа.}

 @item{@racketidfont{конец-абзаца} --- конечная позиция заданного абзаца.
  Абзацы нумеруются с нуля. Аргументы: номер абзаца и
  @racketidfont{видимый?} (по умолчанию @racketvalfont{истина}).

  Если абзацев меньше, чем номер плюс один, возвращается конец
  последнего абзаца. Если номер меньше нуля --- конец первого абзаца.

  Если абзац заканчивается невидимыми элементами (например, переносом
  строки) и @racketidfont{видимый?} не @racketvalfont{ложь}, возвращается
  первая позиция перед этими элементами.}

 @item{@racketidfont{прокрутить-к-позиции} --- прокручивает показ так,
  чтобы заданная позиция стала видна. Возвращает
  @racketvalfont{истина}, если документ прокрутился, иначе
  @racketvalfont{ложь}. Если обновление отложено, запрос запоминается
  до конца отложения. Показ сам может прокручивать документ, не вызывая
  этот метод (например, полоса прокрутки картины).}

 @item{@racketidfont{после-вставки} --- событие после вставки элементов
  (и после обновления показа). Аргументы: начало вставки и длина
  вставленного в позициях. В базовом классе ничего не делает. Чтобы
  при правке в этом методе не было лишних перерисовок, используйте
  @racketidfont{начать-последовательность-редактирования}. Внутренние
  замки при вызове не ставятся.}

 @item{@racketidfont{после-объединения-кусков} --- событие после слияния
  соседних кусков в один. Аргумент --- позиция, где слились куски
  (один был сразу перед ней, другой сразу после, новый охватывает её).
  В базовом классе ничего не делает.}

 @item{@racketidfont{можно-менять-стиль?} --- вызывается перед сменой
  стиля на участке. Аргументы: начало и длина. Если вернуть
  @racketvalfont{ложь}, смена отменяется. Во время вызова документ
  заперт на запись; правки, если нужны, делайте в событиях после смены
  стиля или через последовательность редактирования. В базовом классе
  возвращает @racketvalfont{истина}.}

]

Унаследованные методы @racket[редактор<%>]:
@racketidfont{добавить-картину}, @racketidfont{добавить-отменятель},
@racketidfont{начать-последовательность-редактирования},
@racketidfont{закончить-последовательность-редактирования},
@racketidfont{команды-редактора}, @racketidfont{первый-кусок},
@racketidfont{вставить-из-буфера}, @racketidfont{размеры},
@racketidfont{обработать-изменение-размера},
@racketidfont{глобальные->местные},
@racketidfont{максимальная-ширина}, @racketidfont{минимальная-ширина},
...
Фрагмент документа. Методы: @racketidfont{следующий}, @racketidfont{предыдущий},
@racketidfont{текст}, @racketidfont{скопировать},
@racketidfont{количество} и @racketidfont{стиль} (чтение и запись),
@racketidfont{параметры} --- список символов
(@racket['текст], @racket['можно-объединять], @racket['невидимый],
@racket['перенос], @racket['перенос-после], @racket['обрабатывает-события]
и другие из того же ряда).

События: @racketidfont{при-получении-клавиши},
@racketidfont{при-получении-события}, @racketidfont{изменён-размер}.}
...
Наследует @racket[кусок%]. Метод @racketidfont{изображение} читает
и задаёт растр.}

@defthing[#:kind "класс" кусок-с-редактором% любой]{
Наследует @racket[кусок%]. Вложенный редактор.
Аргументы @racketidfont{редактор} и @racketidfont{есть-граница}.
Методы @racketidfont{редактор}, @racketidfont{максимальная-ширина},
@racketidfont{минимальная-ширина}, @racketidfont{максимальная-высота},
@racketidfont{минимальная-высота}.}

@defthing[#:kind "класс" список-стилей% любой]{
Список именованных стилей документа. Модуль
@racketidfont{графический-интерфейс/стиль}.}

@defthing[#:kind "класс" стиль% любой]{
Стиль начертания куска. Тот же модуль.}

@defthing[#:kind "класс" отклонение-стиля% любой]{
Отличие стиля от базового при @racketidfont{изменить-стиль}.}
