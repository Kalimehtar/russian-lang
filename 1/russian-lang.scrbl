...
Классы Адины хранят внутри объект Racket (поле @racketidfont{внутренний}) и переводят
...
Окно нужно показать методом @racketidfont{показать}:
...
Родитель элемента задаётся аргументом инициализации @racketidfont{родитель}.
У кнопок действие передаётся аргументом @racketidfont{команда}
(функция от элемента и события). У текстового поля текущая строка читается
и записывается методом @racketidfont{значение}.
...
(@racketidfont{при-закрытии}, @racketidfont{при-изменении-размера})
или вопросом (@racketidfont{можно-закрыть?}).
...
(@racketidfont{команда} у кнопки, @racketidfont{при-изменении} у поля,
@racketidfont{обработка} у картины).

Многие методы работают как «геттер и сеттер»: без аргументов читают значение,
с одним аргументом записывают его. Так устроены @racketidfont{заголовок},
@racketidfont{значение}, @racketidfont{минимальная-ширина}, @racketidfont{выравнивание}.
...
Аргументы инициализации: @racketidfont{заголовок} (строка, по умолчанию пустая),
@racketidfont{ширина} и @racketidfont{высота}
(число или @racketvalfont{ложь} --- размер по содержимому),
плюс общие аргументы вместилища: @racketidfont{родитель},
@racketidfont{граница}, @racketidfont{интервал}, @racketidfont{выравнивание}
(по умолчанию @racket['(центр верх)]),
@racketidfont{минимальная-ширина}, @racketidfont{минимальная-высота},
@racketidfont{растягивается-ширина}, @racketidfont{растягивается-высота},
@racketidfont{включен}.

Основные методы: @racketidfont{показать}, @racketidfont{включить},
@racketidfont{заголовок}, @racketidfont{ширина}, @racketidfont{высота},
@racketidfont{переместить}, @racketidfont{установить-размер},
@racketidfont{в-центр} (направление @racket['оба], @racket['по-горизонтали]
или @racket['по-вертикали]),
@racketidfont{создать-строку-состояния}, @racketidfont{показать-состояние},
@racketidfont{сфокусировать}, @racketidfont{обновить}.
События: @racketidfont{можно-закрыть?}, @racketidfont{при-закрытии},
@racketidfont{при-активации}, @racketidfont{при-выходе},
@racketidfont{при-изменении-дисплея}.

@racket[диалог%] --- модальное или вспомогательное окно.
Те же аргументы инициализации и методы @racket[главное-окно<%>], что у
@racket[главное-окно%].

Интерфейс @racket[область<%>] задаёт @racketidfont{родитель}, @racketidfont{главное-окно},
@racketidfont{минимальная-ширина}, @racketidfont{минимальная-высота},
@racketidfont{минимальные-размеры-вывода},
@racketidfont{растягивается-ширина}, @racketidfont{растягивается-высота}.

@racket[окно<%>] расширяет @racket[область<%>]. Показ и активность:
@racketidfont{показать}, @racketidfont{показано?},
@racketidfont{включить}, @racketidfont{включено?},
@racketidfont{есть-фокус?}, @racketidfont{сфокусировать}.
Геометрия: @racketidfont{ширина}, @racketidfont{высота},
@racketidfont{лево}, @racketidfont{верх}, @racketidfont{размеры},
@racketidfont{внутренние-размеры}, @racketidfont{окно->экран},
@racketidfont{экран->окно}. Прочее: @racketidfont{заголовок},
@racketidfont{курсор}, @racketidfont{принимать-файлы},
@racketidfont{контекстное-меню}, @racketidfont{режим-колеса-мыши}
(@racket['по-одному], @racket['по-целым], @racket['сразу]).

@racket[главное-окно<%>] расширяет @racket[вместилище-окно<%>].
Дополнительно: @racketidfont{пространство-событий},
@racketidfont{объект-в-фокусе}, @racketidfont{окно-в-фокусе},
@racketidfont{установить-иконку}.
...
Аргументы: @racketidfont{родитель}, @racketidfont{граница}, @racketidfont{интервал},
@racketidfont{выравнивание} (по умолчанию @racket['(центр центр)]),
размеры и растягивание области, @racketidfont{горизонтальные-поля},
@racketidfont{вертикальные-поля}.
...
Дополнительный аргумент @racketidfont{стиль} --- список символов стиля.

@racket[горизонтальная-панель%] --- горизонтальная панель.
Метод @racketidfont{ориентация} читает и задаёт направление.

@racket[вертикальная-панель%] --- вертикальная панель с тем же методом @racketidfont{ориентация}.

У @racket[вместилище<%>]: @racketidfont{элементы}, @racketidfont{добавить-элемент},
@racketidfont{удалить-элемент}, @racketidfont{изменить-элементы},
@racketidfont{начать-изменения} и @racketidfont{закончить-изменения}
(пакет обновлений раскладки),
@racketidfont{пересчитать-положения}, @racketidfont{граница},
@racketidfont{интервал}, @racketidfont{выравнивание}.
...
@racketidfont{графический-интерфейс/табличная-панель}.
Аргументы: @racketidfont{измерения} --- список @racket['(ряды колонки)],
по умолчанию @racket['(1 1)];
@racketidfont{заполнять} --- @racket['ряд] или @racket['колонку];
@racketidfont{колонки-растягиваются} и @racketidfont{ряды-растягиваются} ---
@racket['любая] или @racket['каждая].

@subsection[#:tag "gui-controls"]{Элементы управления и меню}

@racket[кнопка%] --- кнопка. Аргументы: @racketidfont{заголовок}, @racketidfont{родитель},
@racketidfont{команда} (функция от кнопки и события; по умолчанию ничего не делает),
@racketidfont{шрифт} (по умолчанию @racket[шрифт-элемента-управления]),
@racketidfont{стиль}, размеры и растягивание
(по умолчанию кнопка не растягивается).

@racket[надпись%] --- статический текст или картинка-подпись.
Аргументы: @racketidfont{заголовок} (строка или изображение),
@racketidfont{цвет}, @racketidfont{размер-по-заголовку}.
Методы @racketidfont{цвет} и @racketidfont{размер-по-заголовку}
читают и меняют эти свойства.

@racket[текстовое-поле%] --- однострочное или многострочное поле.
Аргументы: @racketidfont{заголовок}, @racketidfont{значение} (начальная строка, по умолчанию пустая),
@racketidfont{при-изменении} (функция от поля и @racketidfont{событие-управления}),
@racketidfont{стиль} (по умолчанию @racket['(однострочное)]),
@racketidfont{растягивается-ширина} (по умолчанию @racketvalfont{истина}).
Метод @racketidfont{значение} читает и записывает текст.
...
Аргумент @racketidfont{родитель} --- главное окно или диалог.

@racket[меню%] --- выпадающее меню. Аргументы @racketidfont{родитель} и @racketidfont{заголовок}.

@racket[пункт-меню%] --- пункт меню. Аргументы: @racketidfont{родитель}, @racketidfont{заголовок},
@racketidfont{действие} (колбэк). Методы интерфейсов
@racket[пункт-меню<%>] и @racket[пункт-меню-с-заголовком<%>]:
@racketidfont{удалить}, @racketidfont{восстановить}, @racketidfont{удалён?},
@racketidfont{родитель}, @racketidfont{заголовок}, @racketidfont{включить},
@racketidfont{включён?}, @racketidfont{строка-помощи}.

@subsection[#:tag "gui-fonts-events"]{Шрифты и события}

@racket[шрифт%] описывает шрифт. Аргументы инициализации:
@racketidfont{размер} (12), @racketidfont{семейство},
@racketidfont{имя}, @racketidfont{стиль}
(@racket['нормальный], @racket['наклонный], @racket['курсив]),
@racketidfont{насыщенность}
(@racket['тонкая], @racket['светлая], @racket['нормальная], @racket['жирная],
@racket['тяжёлая] и промежуточные значения в том же ряду),
@racketidfont{подчёркнутый?}, @racketidfont{сглаживание}
(@racket['стандартное], @racket['частичное], @racket['полное], @racket['отсутствует]),
@racketidfont{размер-в-пикселях?}, @racketidfont{округлять-метрики?},
@racketidfont{свойства}. Методы с теми же именами читают параметры.
...
@racket[событие%] --- базовое событие с методом @racketidfont{время}.
События мыши, клавиатуры и элементов управления создаются обёртками
при доставке в методы Адины. У события мыши: @racketidfont{тип}
...
@racketidfont{лево}, @racketidfont{верх},
@racketidfont{нажата-кнопка?} и @racketidfont{отпущена-кнопка?}
с аргументом @racket['левая], @racket['правая], @racket['средняя] или @racket['любая].
У события управления @racketidfont{тип} бывает
...
@racketidfont{холст}, @racketidfont{фон}, @racketidfont{отрисовать-немедленно}.

@racket[поле-редактора%] --- холст редактора.
Аргумент @racketidfont{редактор} --- объект @racket[текст%] или другой
@racket[редактор<%>].

@racket[текст%] --- текстовый редактор. Аргументы: @racketidfont{межстрочный-промежуток} (1.0),
@racketidfont{автоматический-перенос}.
Методы: @racketidfont{вставить}, @racketidfont{очистить},
@racketidfont{только-просмотр}, @racketidfont{найти-позицию},
@racketidfont{найти-кусок}, @racketidfont{изменить-стиль},
@racketidfont{последняя-позиция}, @racketidfont{конец-абзаца},
@racketidfont{первый-кусок}.

Функция @racket[для-каждого-куска] вызывает переданную функцию для каждого куска документа по порядку.

@racket[кусок%] --- фрагмент документа редактора. Методы: @racketidfont{следующий},
@racketidfont{предыдущий}, @racketidfont{текст}, @racketidfont{количество},
@racketidfont{параметры}, @racketidfont{стиль}, @racketidfont{скопировать}.
...
Метод @racketidfont{изображение} читает и задаёт растр.

@racket[кусок-с-редактором%] --- вложенный редактор.
Аргументы @racketidfont{редактор} и @racketidfont{есть-граница}.
...
@tabular[#:sep @hspace[1]
         (list (list @bold{Модуль} @bold{Что экспортирует})
               ...
               (list @racketidfont{графический-интерфейс/текст}
                     @elem{@racket[текст%], @racket[для-каждого-куска]})
               (list @racketidfont{графический-интерфейс/кусок} "классы кусков документа")
...
@subsubsection[#:tag "draw-ref-color"]{Цвет}

@defthing[#:kind "класс" цвет% любой]{
Цвет: красный, зелёный и синий составляющие (целые числа от 0 до 255)
и укрывистость (вещественное число от 0 до 1). Например, все нули и
укрывистость 1 --- непрозрачный чёрный; все 255 и укрывистость 1 ---
непрозрачный белый; красный 255 и укрывистость 0,5 --- полупрозрачный
красный.

Аргументы инициализации: @racketidfont{красный}, @racketidfont{зелёный},
@racketidfont{синий} (по умолчанию 0), @racketidfont{укрывистость}
(по умолчанию 0.0). Вместо составляющих можно передать
@racketidfont{образец}: другой @racket[цвет%], символ имени из
@racket[стандартные-цвета] или уже готовое значение цвета.
@racketidfont{внутренний} --- готовый внутренний объект цвета.

Если задан @racketidfont{внутренний} или @racketidfont{образец},
составляющие игнорируются. Без образца и без внутреннего объекта
создаётся цвет из составляющих; укрывистость по умолчанию 0 --- цвет
полностью прозрачный, пока её не задать явно.}

@defthing[#:kind "значение" стандартные-цвета любой]{
Справочник именованных цветов. Методы:

@itemlist[
 @item{@racketidfont{найти} --- по символу или строке возвращает цвет.
  Распознаются символы @racket['белый], @racket['синий],
  @racket['голубой], @racket['красный], @racket['оранжевый],
  @racket['чёрный], @racket['жёлтый], @racket['зелёный],
  @racket['тёмно-зелёный], @racket['серый], @racket['светло-жёлтый].
  Иначе имя передаётся как строка в общий справочник цветов;}
 @item{@racketidfont{имена} --- список всех имён в справочнике.}
]}

@defproc[#:kind "функция" (внутренний-цвет [образец любой])
         любой]{
Возвращает внутреннее представление цвета. Если @racket[образец] ---
@racket[цвет%], берётся его внутренний объект; если символ --- цвет
ищется в @racket[стандартные-цвета]; иначе возвращается
@racket[образец] как есть.}

@subsubsection[#:tag "draw-ref-dc"]{Холст}

@defthing[#:kind "класс" холст% любой]{
Контекст рисования: линии, фигуры, текст и изображения. Холст картины
даёт метод @racketidfont{холст}; у @racket[изображение%] --- тоже
@racketidfont{холст}. Модуль @racketidfont{рисование/холст} предоставляет
@racket[холст-адины]; объекты, которые она возвращает, принадлежат
этому классу.

Координаты --- в единицах рисования холста. Углы --- в радианах:
0 направо, половина пи вверх, против часовой стрелки.

@itemlist[

 @item{@racketidfont{залить-фоном} --- заполняет область текущим цветом
  фона. См. также @racketidfont{очистить}.}

 @item{@racketidfont{очистить} --- для холста с каналом прозрачности
  обнуляет прозрачность; для прозрачной картины стирает рисунок, чтобы
  был виден фон; иначе заливает белым.}

 @item{@racketidfont{копировать} --- копирует прямоугольник
  (@racketidfont{лево}, @racketidfont{верх}, @racketidfont{ширина},
  @racketidfont{высота}) в точку (@racketidfont{лево-цели},
  @racketidfont{верх-цели}) на том же холсте. Области могут
  пересекаться.}

 @item{@racketidfont{нарисовать-дугу} --- дуга эллипса, вписанного в
  прямоугольник лево--верх--ширина--высота. Углы: от начального к
  конечному против часовой стрелки. Если углы равны, рисуется полный
  эллипс. Контур --- текущим пером; если кисть не прозрачная, сектор
  заливается кистью.}

 @item{@racketidfont{нарисовать-эллипс} --- эллипс в прямоугольнике
  лево--верх--ширина--высота. Перо --- контур, кисть --- заливка.}

 @item{@racketidfont{нарисовать-прямоугольник} --- прямоугольник с тем
  же смыслом пера и кисти.}

 @item{@racketidfont{нарисовать-закруглённый-прямоугольник} ---
  прямоугольник со скруглёнными углами. Аргумент @racketidfont{радиус}
  по умолчанию $-0.25$: положительный --- радиус дуги угла,
  отрицательный --- доля меньшей стороны. Если величина слишком велика,
  берётся половина ширины или высоты.}

 @item{@racketidfont{нарисовать-линию} --- отрезок от
  (@racketidfont{лево-начала}, @racketidfont{верх-начала}) до
  (@racketidfont{лево-конца}, @racketidfont{верх-конца}).}

 @item{@racketidfont{нарисовать-линии} --- ломаная по списку точек.
  Необязательные @racketidfont{сместить-вправо} и
  @racketidfont{сместить-вниз} (по умолчанию 0) сдвигают все точки.}

 @item{@racketidfont{нарисовать-многоугольник} --- многоугольник по
  списку точек. Смещения как у линий. @racketidfont{стиль-заполнения}
  по умолчанию @racket['чёт-нечет]; иное значение --- правило ненулевой
  обмотки.}

 @item{@racketidfont{нарисовать-контур} --- рисует контур. Смещения и
  @racketidfont{стиль-заполнения} как у многоугольника.}

 @item{@racketidfont{нарисовать-точку} --- точка в
  (@racketidfont{лево}, @racketidfont{верх}).}

 @item{@racketidfont{нарисовать-лекало} --- сплайн от начала до конца
  через контрольную точку. Каждая точка --- список из лево и верх или
  объект с полями @racketidfont{лево} и @racketidfont{верх}.}

 @item{@racketidfont{нарисовать-текст} --- строка текущим шрифтом.
  Аргументы: текст, лево, верх; @racketidfont{комбинировать}
  (по умолчанию @racketvalfont{ложь} --- литеры рисуются по
  отдельности); @racketidfont{начальная-литера} (с какой литеры начать,
  по умолчанию 0); @racketidfont{угол} в радианах против часовой
  стрелки (по умолчанию 0). Если @racketidfont{комбинировать} ---
  @racket['графемы], соседние литеры одного знака рисуются вместе;
  любое другое истинное значение может включать лигатуры, кернинг
  и письмо справа налево.}

 @item{@racketidfont{нарисовать-изображение} --- рисует
  @racket[изображение%] в (@racketidfont{лево-цели},
  @racketidfont{верх-цели}). @racketidfont{стиль} (по умолчанию
  @racket['обычный]) и @racketidfont{цвет} (по умолчанию чёрный)
  учитываются только для чёрно-белого изображения:
  @racket['непрозрачный] закрашивает белые пиксели фоном.
  @racketidfont{маска} --- другое изображение того же размера или
  @racketvalfont{ложь}. Возвращает @racketvalfont{истина}, если рисунок
  удался.}

 @item{@racketidfont{нарисовать-часть-изображения} --- как
  @racketidfont{нарисовать-изображение}, но копирует прямоугольник
  источника (@racketidfont{лево-части}, @racketidfont{верх-части},
  @racketidfont{ширина-части}, @racketidfont{высота-части}).}

 @item{@racketidfont{начать-слой} / @racketidfont{закончить-слой} ---
  откладывают рисование до конца слоя, затем переносят результат с
  заданной прозрачностью (от 0 до 1), умноженной на текущую.
  На время слоя текущая прозрачность становится 1. В отличие от
  @racketidfont{прозрачность}, перекрывающиеся штрихи слоя тускнеют
  вместе, а не по отдельности.}

 @item{@racketidfont{прозрачность} --- без аргумента читает
  непрозрачность рисования (от 0 до 1), с аргументом задаёт её.}

 @item{@racketidfont{фон} --- цвет фона для @racketidfont{залить-фоном}
  (чтение и запись).}

 @item{@racketidfont{кисть} --- без аргументов возвращает текущую кисть;
  с кистью задаёт её; с цветом и стилем создаёт кисть этого цвета.
  Цвет может быть символом из @racket[стандартные-цвета]. Стиль
  @racket['непрозрачный] --- непрозрачная кисть, иначе сплошная.}

 @item{@racketidfont{масштаб} --- без аргументов возвращает масштаб;
  с @racketidfont{по-ширине} и @racketidfont{по-высоте} задаёт его.}

 @item{@racketidfont{ключ-метрики-шрифта} --- целое число для кэша
  размеров текста: одинаковый ключ значит одинаковые метрики. Ноль ---
  кэшировать нельзя.}

 @item{@racketidfont{отрисовать-немедленно} --- сбрасывает отложенную
  отрисовку картины; для прочих холстов ничего не делает.}

 @item{@racketidfont{начать-документ} / @racketidfont{закончить-документ},
  @racketidfont{начать-страницу} / @racketidfont{закончить-страницу} ---
  печать: сообщение к началу документа, затем страницы по очереди.}

]}

@defproc[#:kind "функция" (холст-адины [внутренний любой])
         холст%]{
Оборачивает уже созданный холст в объект @racket[холст%]. Так получают
холст картины и холст растра.}

@subsubsection[#:tag "draw-ref-bitmap"]{Изображение}

@defthing[#:kind "класс" изображение% любой]{
Растр: цветной, чёрно-белый или с каналом прозрачности. У изображения
есть масштаб подложки: сколько пикселей приходится на одну единицу
рисования (у чёрно-белого всегда 1).

Нужно задать либо @racketidfont{файл}, либо оба @racketidfont{ширина} и
@racketidfont{высота}, либо @racketidfont{внутренний}. Иначе
вызывается исключение с сообщением, что ширина и высота обязательны.

Аргументы инициализации:
@racketidfont{ширина} и @racketidfont{высота} (обязательны вместе, если
нет файла и нет внутреннего объекта); @racketidfont{масштаб} (1.0);
@racketidfont{файл}; @racketidfont{вид-файла} (по умолчанию вид
определяется по содержимому); @racketidfont{цвет-фона};
@racketidfont{неудачная-загрузка-ошибка?}
(по умолчанию @racketvalfont{ложь});
@racketidfont{хранить-данные-файла?}; @racketidfont{байты} ---
чёрно-белый растр из битов (восемь пикселей в байте, 1 --- чёрный);
@racketidfont{чёрно-белое?}; @racketidfont{прозрачность?};
@racketidfont{внутренний} --- готовый внутренний растр.

Пустой растр заданной ширины и высоты --- белый; с каналом прозрачности
начальная прозрачность полная. Если заданы байты, ширина и высота,
создаётся чёрно-белый растр из этих битов.

@itemlist[

 @item{@racketidfont{ширина} и @racketidfont{высота} --- размеры в
  единицах рисования.}

 @item{@racketidfont{масштаб} --- масштаб подложки.}

 @item{@racketidfont{глубина-цвета} --- 1 для чёрно-белого, 32 для
  цветного.}

 @item{@racketidfont{чёрно-белое?} --- @racketvalfont{истина}, если растр
  не цветной.}

 @item{@racketidfont{есть-прозрачность?} --- есть ли канал прозрачности.}

 @item{@racketidfont{работает?} --- @racketvalfont{истина}, если
  изображение удалось загрузить; иначе рисование в него и из него не
  действует.}

 @item{@racketidfont{холст} --- холст для рисования по этому растру или
  @racketvalfont{ложь}.}

 @item{@racketidfont{загрузить-файл} --- читает файл. Аргументы: файл,
  вид-файла, цвет-фона, неудачная-загрузка-ошибка?,
  @racketidfont{хранить-данные-файла?}. Допустимо, только если масштаб
  подложки равен 1.}

 @item{@racketidfont{записать-файл} --- записывает файл. Аргументы:
  файл, вид-файла, @racketidfont{качество} (75),
  @racketidfont{без-масштаба?}.}

 @item{@racketidfont{данные-файла} --- если при загрузке просили
  сохранить данные, возвращает содержимое файла; иначе
  @racketvalfont{ложь}.}

 @item{@racketidfont{загруженная-маска} --- маска прозрачности,
  полученная при загрузке, или @racketvalfont{ложь}. Чтение и запись.
  Сама по себе при рисовании не применяется: её передают как
  @racketidfont{маска} в @racketidfont{нарисовать-изображение}.}

 @item{@racketidfont{пиксели-в-байты} --- копирует прямоугольник в
  изменяемые байты (по четыре байта на пиксель: прозрачность, красный,
  зелёный, синий). @racketidfont{только-прозрачность?} --- только канал
  прозрачности; @racketidfont{учитывать-прозрачность?} --- значения уже
  умножены на прозрачность; @racketidfont{без-масштаба?} --- координаты
  в пикселях, без масштаба подложки.}

 @item{@racketidfont{байты-в-пиксели} --- обратная запись из байтов в
  прямоугольник растра. Те же необязательные аргументы.}

 @item{@racketidfont{указатель} --- низкоуровневая ручка растра.}
...
@racket[изображение%]. Общие ключевые аргументы: @racketidfont{цвет}
(символ из @racket[стандартные-цвета] или @racket[цвет%]; если цвет ---
символ, он ищется в справочнике), @racketidfont{высота} и
...
аргумент передан: так устроены @racketidfont{заголовок},
@racketidfont{значение}, @racketidfont{минимальная-ширина},
@racketidfont{выравнивание}. События --- методы с приставкой
@racketidfont{при-} или с вопросом (@racketidfont{можно-закрыть?});
...
@defthing[#:kind "класс" объект-графического-интерфейса% любой]{
Общий предок окон, элементов, шрифтов, событий, кусков и стилей.
Модуль @racketidfont{графический-интерфейс/объект}.

Аргумент инициализации @racketidfont{внутренний} --- уже созданный
внутренний объект; если его нет, наследник создаёт свой.
Метод @racketidfont{внутренний} возвращает этот объект.}

@subsubsection[#:tag "gui-ref-interfaces"]{Интерфейсы}
...
@itemlist[
 @item{@racketidfont{родитель} --- вместилище, в котором лежит область,
 ...
 @item{@racketidfont{минимальная-ширина} и @racketidfont{минимальная-высота}
...
Аргументы инициализации у реализующих классов: @racketidfont{родитель}
(обязателен, если не окно верхнего уровня), @racketidfont{минимальная-ширина},
@racketidfont{минимальная-высота} (по умолчанию @racketvalfont{ложь}),
@racketidfont{растягивается-ширина} и @racketidfont{растягивается-высота}
(по умолчанию @racketvalfont{истина}).}

@defthing[#:kind "интерфейс" окно<%> любой]{
Расширяет @racket[область<%>]. Показ, фокус, геометрия и события окна.
Модуль @racketidfont{графический-интерфейс/интерфейс-окно}.

Показ и активность:

@itemlist[
 @item{@racketidfont{показать} --- показать или скрыть окно (аргумент
  не @racketvalfont{ложь} --- показать);}
 @item{@racketidfont{показано?} --- видно ли окно;}
 @item{@racketidfont{включить} --- разрешить или запретить взаимодействие;}
 @item{@racketidfont{включено?} --- можно ли взаимодействовать;}
 @item{@racketidfont{есть-фокус?} --- есть ли клавиатурный фокус;}
 @item{@racketidfont{сфокусировать} --- отдать окну фокус.}
]

Геометрия:

@itemlist[
 @item{@racketidfont{ширина} и @racketidfont{высота} --- внешний размер;}
 @item{@racketidfont{лево} и @racketidfont{верх} --- положение относительно
  родителя или экрана у окна верхнего уровня;}
 @item{@racketidfont{размеры} --- два значения: внешние ширина и высота;}
 @item{@racketidfont{внутренние-размеры} --- два значения: ширина и высота
  клиентской области без рамки;}
 @item{@racketidfont{окно->экран} --- из координат окна в экранные;}
 @item{@racketidfont{экран->окно} --- из экранных в координаты окна;}
 @item{@racketidfont{переместить-курсор} --- поставить указатель мыши
  в точку окна.}
]
...
@itemlist[
 @item{@racketidfont{заголовок} --- подпись окна или элемента (чтение
  и запись);}
 @item{@racketidfont{курсор} --- вид указателя над окном;}
 @item{@racketidfont{принимать-файлы} --- принимать ли перетаскивание
  файлов (чтение и запись);}
 @item{@racketidfont{контекстное-меню} --- показать @racket[всплывающее-меню%]
  в точке (меню, лево, верх);}
 @item{@racketidfont{указатель} --- низкоуровневая ручка окна;}
 @item{@racketidfont{обновить} --- запросить перерисовку;}
 @item{@racketidfont{режим-колеса-мыши} --- @racket['по-одному],
  @racket['по-целым] или @racket['сразу].}
]

События (в базовой реализации ничего не делают; клавиша и мышь элемента
возвращают @racketvalfont{ложь} --- событие можно обработать дальше):

@itemlist[
 @item{@racketidfont{при-получении-файла} --- перетащили файл; аргумент ---
  путь;}
 @item{@racketidfont{при-изменении-фокуса} --- аргумент: появился ли фокус;}
 @item{@racketidfont{при-перемещении} --- новое лево и верх;}
 @item{@racketidfont{при-изменении-размера} --- новая ширина и высота;}
 @item{@racketidfont{при-получении-элементом-клавиши} --- клавиша ушла
  потомку; аргументы: элемент и событие клавиши;}
 @item{@racketidfont{при-получении-элементом-события} --- мышь у потомка;}
 @item{@racketidfont{при-изменении-фокуса-элемента} --- фокус потомка;}
 @item{@racketidfont{при-активации-содержащего-окна},
  @racketidfont{при-включении-содержащего-окна},
  @racketidfont{при-показывании-содержащего-окна} --- изменилось
  охватывающее окно.}
]

Дополнительный аргумент инициализации: @racketidfont{включен}
(по умолчанию @racketvalfont{истина}).}

@defthing[#:kind "интерфейс" подобласть<%> любой]{
Расширяет @racket[область<%>]. Отступы внутри вместилища. Модуль
@racketidfont{графический-интерфейс/интерфейс-подобласть}.

@itemlist[
 @item{@racketidfont{горизонтальные-поля} --- отступ слева и справа
  (чтение и запись);}
 @item{@racketidfont{вертикальные-поля} --- отступ сверху и снизу.}
]

У элементов управления поля по умолчанию 2, у групп и панелей --- 0.
Аргументы инициализации с теми же именами.}

@defthing[#:kind "интерфейс" подокно<%> любой]{
Одновременно @racket[окно<%>] и @racket[подобласть<%>]. Модуль
@racketidfont{графический-интерфейс/интерфейс-подокно}.

Метод @racketidfont{родитель} без аргумента читает вместилище, с новым
родителем переносит окно в другое вместилище.}

@defthing[#:kind "интерфейс" вместилище<%> любой]{
Расширяет @racket[область<%>]. Контейнер дочерних элементов. Модуль
@racketidfont{графический-интерфейс/интерфейс-вместилище}.

@itemlist[
 @item{@racketidfont{элементы} --- список детей (объекты Адины);}
 @item{@racketidfont{добавить-элемент} и @racketidfont{удалить-элемент}
  --- показать или убрать уже созданного ребёнка (не уничтожая его);}
 @item{@racketidfont{изменить-элементы} --- функция от списка детей,
  возвращает новый список; порядок в списке --- порядок раскладки;}
 @item{@racketidfont{начать-изменения} и @racketidfont{закончить-изменения}
  --- пакет обновлений раскладки: между ними дети не пересчитываются;}
 @item{@racketidfont{пересчитать-положения} --- сразу переложить детей;}
 @item{@racketidfont{положения-изменены} --- сообщить, что геометрия
  детей могла измениться, и нужна новая раскладка;}
 @item{@racketidfont{граница} --- внутренний отступ у края контейнера
  (чтение и запись, по умолчанию 0);}
 @item{@racketidfont{интервал} --- промежуток между детьми (по умолчанию 0);}
 @item{@racketidfont{выравнивание} --- без аргументов возвращает два
  символа (горизонталь и вертикаль), с двумя символами задаёт их.
  Горизонталь: @racket['лево], @racket['центр], @racket['право].
  Вертикаль: @racket['верх], @racket['центр], @racket['низ];}
 @item{@racketidfont{размер-вместилища} --- по сведениям о детях вернуть
  желаемые ширину и высоту контейнера; в базовой реализации --- расчёт
  предка;}
 @item{@racketidfont{разместить-элементы} --- по сведениям о детях и
  размеру контейнера вернуть положения детей; в базовой реализации ---
  расчёт предка;}
 @item{@racketidfont{после-добавления-элемента} --- событие после появления
  нового ребёнка; аргумент --- этот элемент. В базовой реализации ничего
  не делает.}
]

Аргументы инициализации: @racketidfont{граница}, @racketidfont{интервал},
@racketidfont{выравнивание} --- список из двух символов (у каждого класса
своё умолчание).}

@defthing[#:kind "интерфейс" вместилище-окно<%> любой]{
Одновременно @racket[вместилище<%>] и @racket[окно<%>]. Модуль
@racketidfont{графический-интерфейс/интерфейс-вместилище-окно}.
Отдельных методов нет: это сочетание контейнера и видимого окна
(панель, главное окно, диалог).}

@defthing[#:kind "интерфейс" главное-окно<%> любой]{
Расширяет @racket[вместилище-окно<%>]. Окно верхнего уровня. Модуль
@racketidfont{графический-интерфейс/интерфейс-главное-окно}.

@itemlist[
 @item{@racketidfont{в-центр} --- поставить окно в центр экрана.
  Направление @racket['оба] (по умолчанию), @racket['по-горизонтали]
  или @racket['по-вертикали];}
 @item{@racketidfont{переместить} --- лево и верх на экране;}
 @item{@racketidfont{установить-размер} --- внешние ширина и высота;}
 @item{@racketidfont{пространство-событий} --- очередь событий этого окна;}
 @item{@racketidfont{объект-в-фокусе} --- элемент или редактор с фокусом
  либо @racketvalfont{ложь};}
 @item{@racketidfont{окно-в-фокусе} --- подокно с фокусом либо
  @racketvalfont{ложь};}
 @item{@racketidfont{объект-для-редактирования} --- куда идёт ввод, если
  фокус на картине редактора;}
 @item{@racketidfont{окно-для-редактирования} --- окно этого объекта;}
 @item{@racketidfont{установить-иконку} --- значок окна. Аргументы:
  изображение, необязательная маска (@racketvalfont{ложь}) и какой значок
  сменить: @racket['маленькую], @racket['большую] или @racket['обе]
  (по умолчанию).}
]
...
@itemlist[
 @item{@racketidfont{можно-закрыть?} --- разрешить ли закрытие; по
  умолчанию @racketvalfont{истина};}
 @item{@racketidfont{можно-выйти?} --- разрешить ли выход из приложения;
  по умолчанию вызывает @racketidfont{можно-закрыть?};}
 @item{@racketidfont{при-активации} --- окно стало активным или нет;}
 @item{@racketidfont{при-закрытии} --- окно закрывают;}
 @item{@racketidfont{при-выходе} --- приложение завершают через это окно;}
 @item{@racketidfont{при-получении-сообщения} --- системное сообщение;}
 @item{@racketidfont{при-изменении-дисплея} --- сменились экраны или
  масштаб (есть у @racket[главное-окно%]);}
 @item{@racketidfont{при-получении-клавиши} --- клавиша обхода фокуса;
  @racketvalfont{ложь} --- обработать как обычно, иначе клавиша уже
  обработана.}
]

Выравнивание по умолчанию @racket['(центр верх)], родитель необязателен.}

@defthing[#:kind "интерфейс" элемент-управления<%> любой]{
Расширяет @racket[подокно<%>]. Кнопка, надпись, поле ввода. Модуль
@racketidfont{графический-интерфейс/интерфейс-элемент-управления}.

Метод @racketidfont{команда} передаёт элементу событие управления так,
словно его вызвал пользователь.

По умолчанию элемент не растягивается. Аргументы инициализации:
@racketidfont{шрифт} (по умолчанию @racket[шрифт-элемента-управления]),
@racketidfont{стиль} --- список символов; @racket['скрытая] --- элемент
создан, но не показан в родителе.}

@defthing[#:kind "интерфейс" картина<%> любой]{
Расширяет @racket[подокно<%>]. Холст или поле редактора. Модуль
@racketidfont{графический-интерфейс/интерфейс-картина}.

@itemlist[
 @item{@racketidfont{холст} --- объект @racket[холст%] для рисования
  (см. @secref["draw-ref-dc"]) или @racketvalfont{ложь};}
 @item{@racketidfont{фон} --- цвет фона картины (чтение и запись);}
 @item{@racketidfont{отрисовать-немедленно} --- сбросить отложенную
  отрисовку;}
 @item{@racketidfont{приостановить-отрисовку} и
  @racketidfont{продолжить-отрисовку} --- временно не сбрасывать рисунок
  на экран (вызовы можно вкладывать);}
 @item{@racketidfont{принимать-фокус-табом} --- брать ли фокус по табуляции
  (чтение и запись);}
 @item{@racketidfont{минимальная-ширина-холста} и
  @racketidfont{минимальная-высота-холста} --- минимум клиентской области
  (чтение и запись).}
]

События: если вернуть не @racketvalfont{ложь}, стандартная обработка
не выполняется.

@itemlist[
 @item{@racketidfont{при-получении-клавиши} --- событие клавиши;}
 @item{@racketidfont{при-получении-события} --- событие мыши;}
 @item{@racketidfont{при-отрисовке} --- нужно перерисовать содержимое;}
 @item{@racketidfont{при-входе-табом} --- фокус пришёл табуляцией.}
]

В базовой реализации все четыре возвращают @racketvalfont{ложь}.}

@defthing[#:kind "интерфейс" редактор<%> любой]{
Документ, который показывают через @racket[поле-редактора%] или другую
картину. Его реализует @racket[текст%]. Модуль
@racketidfont{графический-интерфейс/интерфейс-редактор}.

@itemlist[

 @item{@racketidfont{добавить-картину} --- добавляет картину в список
  тех, что показывают этот документ. Обычно вызывается самим полем
  редактора, когда ему задают документ.}

 @item{@racketidfont{добавить-отменятель} --- кладёт функцию отмены на
  стек отмен. Если сейчас выполняется отмена, функция попадает на стек
  повторов. Система вызывает её, когда она первая на стеке.

  Для встроенных действий (вставка, удаление, смена шрифта) записи
  отмены создаются сами. Свой отменятель нужен, когда надо откатить
  действие, которого в документе нет (например, смену своей подписи
  куска). После возврата функция снимается со стека; если её результат
  не @racketvalfont{ложь}, сразу выполняется следующий отменятель ---
  так несколько действий откатываются одним шагом. Имеет смысл
  возвращать не @racketvalfont{ложь}, если отменяемое действие входило
  в последовательность редактирования.}

 @item{@racketidfont{начать-последовательность-редактирования} и
  @racketidfont{закончить-последовательность-редактирования} ---
  обрамляют набор правок, чтобы показ обновился один раз в конце.
  Вызовы можно вкладывать. Это сильно ускоряет перерисовку.

  Если документ содержит вложенные документы, последовательность на
  внешнем частично охватывает и их, но для вложенного эффективнее
  начать свою последовательность.}

 @item{@racketidfont{команды-редактора} --- без аргументов возвращает
  текущий @racket[набор-команд%] или @racketvalfont{ложь}. С аргументом
  задаёт набор; @racketvalfont{ложь} снимает все привязки клавиш.}

 @item{@racketidfont{первый-кусок} --- первый кусок документа или
  @racketvalfont{ложь}, если документ пуст. В текстовом документе это
  кусок в позиции 0. Остальные куски обходятся через
  @racketidfont{следующий}.}

 @item{@racketidfont{вставить-из-буфера} --- вставляет текущее
  содержимое буфера обмена. Необязательный аргумент --- метка времени
  события (по умолчанию 0). Система может вставить из буфера и без
  вызова этого метода.}

 @item{@racketidfont{размеры} --- возвращает два значения: ширину и
  высоту видимой области, в которую сейчас показывают документ.}

 @item{@racketidfont{глобальные->местные} --- переводит координаты
  @racketidfont{лево} и @racketidfont{верх} из системы показа
  (обычно картины) в координаты документа. Возвращает два значения:
  местные лево и верх.}

 @item{@racketidfont{максимальная-ширина},
  @racketidfont{минимальная-ширина},
  @racketidfont{максимальная-высота},
  @racketidfont{минимальная-высота} --- без аргумента читают ограничение
  размера содержимого при показе, с аргументом записывают. Ноль значит,
  что ограничения нет. В текстовом документе отсутствие максимальной
  ширины отключает автоматический перенос строк.}

 @item{@racketidfont{обработать-изменение-размера} --- вызывает
  @racketidfont{при-изменении-размера}, если документ не в середине
  последовательности редактирования и не перерисовывается сейчас.
  Иначе вызов откладывается.}

 @item{@racketidfont{при-получении-события} --- событие мыши по
  документу. Аргумент --- обёрнутое событие мыши. В базовом классе
  возвращает @racketvalfont{истина}: тогда обработка события
  продолжается (клавиши, кусок с курсором, выбор куска). Если
  переопределить и вернуть @racketvalfont{ложь}, дальнейшая обработка
  не выполняется.}

 @item{@racketidfont{при-получении-необработанного-события} ---
  вызывается, когда событие мыши не обработал кусок с курсором и не
  обработал набор команд. Аргумент --- обёрнутое событие мыши. В
  базовом классе возвращает @racketvalfont{истина}, и обработка
  события продолжается. Значение @racketvalfont{ложь} её прерывает.}

 @item{@racketidfont{при-изменении-размера} --- показ изменил размер
  видимой области (как у @racketidfont{размеры}). Вызывается не
  напрямую, а через @racketidfont{обработать-изменение-размера}.
  В базовом классе ничего не делает. Если включён автоматический
  перенос, исходная реализация подстраивает максимальную ширину под
  картины документа.}

 @item{@racketidfont{при-начале-последовательности-редактировании} ---
  внешняя (не вложенная) последовательность редактирования только что
  началась. Во время последовательности остальные события вызываются
  как обычно, но долгие вычисления лучше отложить до её конца.
  В базовом классе ничего не делает.}

]}

@defthing[#:kind "интерфейс" пункт-меню<%> любой]{
Пункт в строке меню, выпадающем или всплывающем меню. Определён в сводке
@racketidfont{графический-интерфейс}.

@itemlist[
 @item{@racketidfont{родитель} --- меню или строка меню, в которой лежит
  пункт;}
 @item{@racketidfont{удалить} --- убрать пункт из меню, не уничтожая его;}
 @item{@racketidfont{восстановить} --- вернуть ранее удалённый пункт
  на прежнее место;}
 @item{@racketidfont{удалён?} --- убран ли пункт.}
]}

@defthing[#:kind "интерфейс" пункт-меню-с-заголовком<%> любой]{
Расширяет @racket[пункт-меню<%>]. Пункт с подписью.

@itemlist[
 @item{@racketidfont{заголовок} --- текст пункта (чтение и запись);}
 @item{@racketidfont{включить} --- разрешить или запретить выбор;}
 @item{@racketidfont{включён?} --- можно ли выбрать пункт;}
 @item{@racketidfont{строка-помощи} --- подсказка в строке состояния
  (чтение и запись; @racketvalfont{ложь} --- без подсказки).}
]}

@subsubsection[#:tag "gui-ref-windows"]{Окна и диалоги}

@defthing[#:kind "класс" главное-окно% любой]{
Реализует @racket[главное-окно<%>]. Окно верхнего уровня с рамкой,
заголовком и, при необходимости, строкой состояния. Модуль
@racketidfont{графический-интерфейс/главное-окно}.

Аргументы инициализации: @racketidfont{заголовок} (строка, по умолчанию
пустая), @racketidfont{ширина} и @racketidfont{высота} (число или
@racketvalfont{ложь} --- размер по содержимому), плюс аргументы
вместилища-окна (@racketidfont{родитель} необязателен, выравнивание
по умолчанию @racket['(центр верх)]).

Дополнительно к методам @racket[главное-окно<%>]:

@itemlist[
 @item{@racketidfont{создать-строку-состояния} --- добавить полосу
  состояния внизу окна;}
 @item{@racketidfont{показать-состояние} --- текст в этой полосе.}
]}

@defthing[#:kind "класс" диалог% любой]{
Реализует @racket[главное-окно<%>]. Модальное или вспомогательное окно
без строки состояния. Определён в сводке
@racketidfont{графический-интерфейс}.

Те же аргументы инициализации, что у @racket[главное-окно%]: заголовок,
ширина, высота и аргументы вместилища-окна. Методы --- как у
@racket[главное-окно<%>], без @racketidfont{создать-строку-состояния} и
@racketidfont{показать-состояние}.}

@subsubsection[#:tag "gui-ref-layout"]{Вместилища}

@defthing[#:kind "класс" группа% любой]{
Реализует @racket[вместилище<%>] и @racket[подобласть<%>]. Контейнер без
собственной рамки: только раскладывает детей. Модуль
@racketidfont{графический-интерфейс/группа}.

Выравнивание по умолчанию @racket['(центр центр)]. Поля по умолчанию 0.
Родитель обязателен. Методы --- как у этих интерфейсов.}

@defthing[#:kind "класс" горизонтальная-группа% любой]{
Наследует @racket[группа%]. Дети слева направо.
Выравнивание по умолчанию @racket['(лево центр)].}

@defthing[#:kind "класс" вертикальная-группа% любой]{
Наследует @racket[группа%]. Дети сверху вниз.
Выравнивание по умолчанию @racket['(центр верх)].}

@defthing[#:kind "класс" панель% любой]{
Реализует @racket[вместилище-окно<%>] и @racket[подокно<%>]. Видимый
контейнер с фоном. Модуль @racketidfont{графический-интерфейс/панель}.

Дополнительный аргумент @racketidfont{стиль} --- список символов стиля
(по умолчанию пустой). Выравнивание по умолчанию @racket['(центр центр)].
Родитель обязателен. Методы --- как у вместилища-окна и подобласти.}

@defthing[#:kind "класс" горизонтальная-панель% любой]{
Наследует @racket[панель%]. Дети слева направо.
Выравнивание по умолчанию @racket['(лево центр)].

Метод @racketidfont{ориентация} без аргумента: не @racketvalfont{ложь},
если раскладка горизонтальная; с аргументом задаёт горизонтальную
(@racketvalfont{истина}) или вертикальную раскладку.}

@defthing[#:kind "класс" вертикальная-панель% любой]{
Наследует @racket[панель%]. Дети сверху вниз.
Выравнивание по умолчанию @racket['(центр верх)].
Тот же метод @racketidfont{ориентация}.}

@defthing[#:kind "класс" табличная-панель% любой]{
Наследует @racket[панель%]. Подключается отдельно:
@racketidfont{графический-интерфейс/табличная-панель}.
Дети в сетке рядов и колонок. Выравнивание по умолчанию
@racket['(лево центр)].

Аргументы инициализации (кроме аргументов панели):

@itemlist[
 @item{@racketidfont{измерения} --- список из числа рядов и числа колонок,
  по умолчанию @racket['(1 1)];}
 @item{@racketidfont{заполнять} --- что заполнять в первую очередь:
  @racket['ряд] (по умолчанию) или @racket['колонку];}
 @item{@racketidfont{колонки-растягиваются} и
  @racketidfont{ряды-растягиваются} --- @racket['любая] (растягивается
  хотя бы одна) или @racket['каждая] (растягивается каждая), по
  умолчанию @racket['любая].}
]

Методы с теми же именами читают и меняют эти свойства.
@racketidfont{измерения} при записи принимает два числа: ряды и колонки.}

@subsubsection[#:tag "gui-ref-controls"]{Элементы управления и меню}

@defthing[#:kind "класс" кнопка% любой]{
Реализует @racket[элемент-управления<%>]. Модуль
@racketidfont{графический-интерфейс/кнопка}.

Аргументы: @racketidfont{заголовок} (строка или изображение, обязателен),
@racketidfont{родитель} (обязателен), @racketidfont{команда} --- функция
от кнопки и события управления (по умолчанию ничего не делает),
@racketidfont{шрифт}, @racketidfont{стиль} --- список из
@racket['граница] (рамка вокруг кнопки), @racket['многострочная]
(подпись в несколько строк), @racket['скрытая], плюс размеры и
растягивание (по умолчанию не растягивается).

Методы --- как у @racket[элемент-управления<%>]. Нажатие вызывает
@racketidfont{команда}.}

@defthing[#:kind "класс" надпись% любой]{
Реализует @racket[элемент-управления<%>]. Статический текст или картинка.
Модуль @racketidfont{графический-интерфейс/надпись}.

Аргументы: @racketidfont{заголовок} (строка или @racket[изображение%],
обязателен), @racketidfont{цвет} (по умолчанию @racketvalfont{ложь} ---
цвет системы), @racketidfont{размер-по-заголовку} (по умолчанию
@racketvalfont{ложь} --- размер не следит за сменой заголовка), плюс
аргументы элемента управления.

@itemlist[
 @item{@racketidfont{цвет} --- цвет текста (чтение и запись);}
 @item{@racketidfont{размер-по-заголовку} --- подгонять ли размер под
  текущий заголовок (чтение и запись).}
]}

@defthing[#:kind "класс" текстовое-поле% любой]{
Реализует @racket[элемент-управления<%>]. Однострочное или многострочное
поле. Модуль @racketidfont{графический-интерфейс/текстовое-поле}.

Аргументы: @racketidfont{заголовок} (подпись слева или сверху, по
умолчанию @racketvalfont{ложь} --- без подписи), @racketidfont{значение}
--- начальная строка (по умолчанию пустая), @racketidfont{при-изменении}
--- функция от поля и события управления (по умолчанию ничего не делает),
@racketidfont{стиль} (по умолчанию @racket['(однострочное)]; также
@racket['многострочное] и @racket['скрытая]),
@racketidfont{растягивается-ширина} (по умолчанию @racketvalfont{истина}),
плюс остальные аргументы элемента.

Метод @racketidfont{значение} читает и записывает текст. При правке
пользователем вызывается @racketidfont{при-изменении}; тип события ---
@racket['текстовое-поле] или @racket['ввод-в-текстовом-поле].}

@defthing[#:kind "класс" поле-даты% любой]{
Наследует @racket[текстовое-поле%]. Подключается отдельно:
@racketidfont{графический-интерфейс/поле-даты}.
Поле ввода даты: те же аргументы и методы, что у текстового поля,
включая @racketidfont{значение} и @racketidfont{при-изменении}.}

@defthing[#:kind "класс" строка-меню% любой]{
Строка меню окна верхнего уровня. Определена в сводке
@racketidfont{графический-интерфейс}.

Аргумент @racketidfont{родитель} обязателен: @racket[главное-окно%]
или @racket[диалог%]. В строку кладут объекты @racket[меню%].}

@defthing[#:kind "класс" меню% любой]{
Выпадающее меню. Определено в сводке @racketidfont{графический-интерфейс}.

Аргументы @racketidfont{родитель} (строка меню или другое меню) и
@racketidfont{заголовок} обязательны. В меню кладут @racket[пункт-меню%]
или вложенные @racket[меню%].}

@defthing[#:kind "класс" всплывающее-меню% любой]{
Контекстное меню. Определено в сводке @racketidfont{графический-интерфейс}.

Аргумент @racketidfont{заголовок} --- заголовок меню, по умолчанию
пустая строка. Показывают методом @racketidfont{контекстное-меню} окна.
Пункты --- @racket[пункт-меню%].}

@defthing[#:kind "класс" пункт-меню% любой]{
Реализует @racket[пункт-меню<%>] и @racket[пункт-меню-с-заголовком<%>].
Определён в сводке @racketidfont{графический-интерфейс}.

Аргументы: @racketidfont{родитель} (меню, всплывающее меню или строка
меню), @racketidfont{заголовок} и @racketidfont{действие} --- функция,
вызываемая при выборе пункта (получает пункт и событие управления).
Все три обязательны.

Методы интерфейсов: родитель, удаление и восстановление, заголовок,
включение и строка помощи.}

@subsubsection[#:tag "gui-ref-fonts-events"]{Шрифты и события}

@defthing[#:kind "класс" шрифт% любой]{
Описание шрифта. Модуль @racketidfont{графический-интерфейс/шрифт}.

Аргументы инициализации: @racketidfont{размер} (12),
@racketidfont{семейство} (системное семейство по умолчанию),
@racketidfont{имя} (по умолчанию @racketvalfont{ложь} --- взять семейство),
@racketidfont{стиль} --- @racket['нормальный], @racket['наклонный]
или @racket['курсив];
@racketidfont{насыщенность} --- @racket['тонкая], @racket['сверхсветлая],
@racket['светлая], @racket['полусветлая], @racket['книжная],
@racket['нормальная], @racket['средняя], @racket['полужирная],
@racket['жирная], @racket['сверхжирная], @racket['тяжёлая],
@racket['сверхтяжёлая];
@racketidfont{подчёркнутый?} (по умолчанию @racketvalfont{ложь});
@racketidfont{сглаживание} --- @racket['стандартное], @racket['частичное],
@racket['полное], @racket['отсутствует];
@racketidfont{размер-в-пикселях?} (по умолчанию @racketvalfont{ложь}),
@racketidfont{округлять-метрики?} (по умолчанию @racketvalfont{истина}),
@racketidfont{свойства} (соответствие дополнительных свойств, по умолчанию
пустое).

Методы (все только чтение, кроме создания нового объекта через
@racket[на-основе-шрифта]):

@itemlist[
 @item{@racketidfont{размер} --- кегль; необязательный аргумент: считать
  ли размер в пикселях;}
 @item{@racketidfont{размер-в-пикселях?} --- задан ли кегль в пикселях;}
 @item{@racketidfont{семейство}, @racketidfont{имя}, @racketidfont{стиль},
  @racketidfont{насыщенность}, @racketidfont{подчёркнутый?},
  @racketidfont{сглаживание}, @racketidfont{округлять-метрики?},
  @racketidfont{свойства} --- те же величины, что при создании;}
 @item{@racketidfont{идентификатор} --- целое число начертания в системе;}
 @item{@racketidfont{есть-литера?} --- есть ли знак для литеры; второй
  аргумент --- искать ли среди шрифтов заголовка окна (по умолчанию
  @racketvalfont{ложь}).}
]}
...
@defproc[#:kind "функция" (на-основе-шрифта [шрифт шрифт%]
         ...
         шрифт%]{
Новый шрифт, копирующий @racket[шрифт]. Не указанные ключевые аргументы
берутся из исходного шрифта.}

@defthing[#:kind "класс" событие% любой]{
Базовое событие. Модуль @racketidfont{графический-интерфейс/событие}.

Аргумент и метод @racketidfont{время} --- метка времени в миллисекундах
(чтение и запись, по умолчанию 0).}

@defthing[#:kind "класс" событие-мыши% любой]{
Наследует @racket[событие%]. Событие мыши. Обычно получают через
@racket[событие-мыши-адины], а не создают сами.

Аргументы инициализации: @racketidfont{тип} (по умолчанию @racket['вход]),
@racketidfont{время}, @racketidfont{внутренний}.

@itemlist[
 @item{@racketidfont{тип} --- @racket['вход], @racket['выход],
  @racket['левая-нажата], @racket['левая-отпущена],
  @racket['средняя-нажата], @racket['средняя-отпущена],
  @racket['правая-нажата], @racket['правая-отпущена], @racket['движение]
  (чтение и запись);}
 @item{@racketidfont{лево} и @racketidfont{верх} --- координаты в окне;}
 @item{@racketidfont{нажата-кнопка?} и @racketidfont{отпущена-кнопка?} ---
  с аргументом @racket['левая], @racket['правая], @racket['средняя]
  или @racket['любая].}
]}

@defthing[#:kind "класс" событие-клавиши% любой]{
Наследует @racket[событие%]. Событие клавиатуры.

Метод @racketidfont{клавиша} --- код нажатой клавиши (литера или символ
специальной клавиши).}

@defthing[#:kind "класс" событие-управления% любой]{
Наследует @racket[событие%]. Событие кнопки, поля, меню.

Метод @racketidfont{тип} (чтение и запись): @racket['кнопка],
@racket['флажок], @racket['выбор], @racket['список],
@racket['двойной-щелчок-по-списку], @racket['текстовое-поле],
@racket['ввод-в-текстовом-поле], @racket['меню], @racket['ползунок],
@racket['переключатель], @racket['меню-выбрано], @racket['меню-не-выбрано],
@racket['вкладка].}
...
@subsubsection[#:tag "gui-ref-editors"]{Картина, редактор и куски}
...
@racketidfont{при-отрисовке}, получая @racket[холст%] через
@racketidfont{холст}. Система вызывает отрисовку при показе, изменении
размера и по запросу @racketidfont{обновить}; несколько запросов
@racketidfont{обновить} могут объединиться в один вызов
@racketidfont{при-отрисовке}.
...
@racket[заголовок] --- имя картины для @racketidfont{заголовок}; на экране
не показывается. По умолчанию @racketvalfont{ложь}.

@racket[стиль] --- список символов оформления холста (по умолчанию пустой):
рамка, рамка как у элемента управления, горизонтальная или вертикальная
полоса прокрутки, угол для изменения размера, режим трёхмерного
рисования, отключение автоочистки фона, прозрачный фон (сквозь
картину виден родитель), запрет фокуса по щелчку, создание скрытой
картины без влияния на геометрию родителя.

@racket[обработка] --- функция от картины и холста; вызывается, когда
@racketidfont{при-отрисовке} возвращает @racketvalfont{ложь}.
...
отступы у краёв картины.

Кроме перечисленного, доступны аргументы @racket[область<%>] и
@racket[окно<%>]: @racketidfont{минимальная-ширина},
@racketidfont{минимальная-высота}, @racketidfont{растягивается-ширина},
@racketidfont{растягивается-высота}, @racketidfont{включен}.}
...
отмены обрабатываются @racketidfont{при-получении-клавиши} окна верхнего
уровня, а не доходят до картины.}

@defproc[#:kind "метод" (отрисовать-немедленно) пусто?]{
...
@defproc[#:kind "метод" (приостановить-отрисовку) пусто?]{
Временно отключает сброс буфера картины на экран. Вызовы можно
вкладывать; сброс возобновляется после стольких же вызовов
@racketidfont{продолжить-отрисовку}.}

@defproc[#:kind "метод" (продолжить-отрисовку) пусто?]{
Возобновляет сброс буфера после @racketidfont{приостановить-отрисовку}.
См. @racketidfont{приостановить-отрисовку}.}
...
@defproc[#:kind "метод" (при-отрисовке) любой]{
Этот метод переопределяется формой @racket[переопределить].

Вызывается, когда картину нужно перерисовать (показ, изменение размера,
запрос @racketidfont{обновить}). Если вернуть не @racketvalfont{ложь},
...
@defproc[#:kind "метод" (при-входе-табом) любой]{
Этот метод переопределяется формой @racket[переопределить].

Вызывается, когда клавиатурный фокус входит на картину обходом
табуляцией (событие @racketidfont{при-изменении-фокуса} тоже
...
Реализует интерфейс @racket[картина<%>]. Холст, показывающий документ-редактор.
Модуль @racketidfont{графический-интерфейс/поле-редактора}.

Аргументы как у картины, вместо обработки --- @racketidfont{редактор}
(объект @racket[текст%] или другой @racket[редактор<%>], по умолчанию
@racketvalfont{ложь} --- пустое поле). Методы --- как у
@racket[картина<%>].}
...
@racketidfont{начать-последовательность-редактирования}.
Внутренние замки при вызове не ставятся.

См. также @racket[можно-менять-стиль?] и
@racketidfont{при-начале-последовательности-редактировании}.}
...
@defproc[#:kind "метод" (очистить) пусто?]{
...
@defthing[#:kind "класс" кусок% любой]{
Фрагмент документа. Модуль @racketidfont{графический-интерфейс/кусок}.
Создаётся без обязательных аргументов; обычно куски делают наследниками
или получают из документа.

@itemlist[
 @item{@racketidfont{следующий} и @racketidfont{предыдущий} --- соседние
  куски или @racketvalfont{ложь};}
 @item{@racketidfont{текст} --- строка содержимого; аргументы: смещение
  и количество литер;}
 @item{@racketidfont{скопировать} --- копия куска, ещё не вставленная
  в документ;}
 @item{@racketidfont{количество} --- число позиций, которые занимает
  кусок (чтение и запись);}
 @item{@racketidfont{стиль} --- @racket[стиль%] куска (чтение и запись);}
 @item{@racketidfont{параметры} --- список символов (чтение и запись):
  @racket['текст], @racket['можно-объединять], @racket['невидимый],
  @racket['перенос], @racket['перенос-после],
  @racket['обрабатывает-события],
  @racket['обрабатывает-все-события-мыши],
  @racket['обрабатывает-события-между],
  @racket['ширина-зависит-от-положения-левого-края],
  @racket['высота-зависит-от-положения-левого-края],
  @racket['ширина-зависит-от-положения-верхнего-края],
  @racket['высота-зависит-от-положения-верхнего-края],
  @racket['использует-путь-редактора].}
]

События:

@itemlist[
 @item{@racketidfont{при-получении-клавиши} --- холст, лево, верх, лево
  и верх редактора, событие клавиши. В базовом классе ничего не делает;}
 @item{@racketidfont{при-получении-события} --- то же для мыши;}
 @item{@racketidfont{изменён-размер} --- новые ширина и высота. Если
  вернуть не @racketvalfont{ложь}, стандартное изменение размера не
  выполняется. В базовом классе возвращает @racketvalfont{ложь}.}
]}

@defproc[#:kind "функция" (кусок-адины [внутренний любой])
         любой]{
Оборачивает внутренний кусок в подходящий класс Адины
(@racket[кусок-со-строкой%], @racket[кусок-с-изображением%],
@racket[кусок-с-редактором%] или @racket[кусок%]). Если
@racket[внутренний] --- @racketvalfont{ложь}, возвращает
@racketvalfont{ложь}.}

@defthing[#:kind "класс" кусок-со-строкой% любой]{
Наследует @racket[кусок%]. Текстовый фрагмент.

Аргумент @racketidfont{содержимое} --- строка (текст куска) или целое
число (начальный запас мест под литеры), по умолчанию 0.}

@defthing[#:kind "класс" кусок-с-изображением% любой]{
Наследует @racket[кусок%]. Рисунок в документе.

Аргумент @racketidfont{содержимое} --- @racket[изображение%] или
@racketvalfont{ложь}. Метод @racketidfont{изображение} читает и задаёт
растр (@racket[изображение%]).}

@defthing[#:kind "класс" кусок-с-редактором% любой]{
Наследует @racket[кусок%]. Вложенный редактор в ячейке документа.

Аргументы: @racketidfont{редактор} (объект @racket[редактор<%>] или
@racketvalfont{ложь}) и @racketidfont{есть-граница} (по умолчанию
@racketvalfont{истина} --- рамка вокруг вложенного документа).

@itemlist[
 @item{@racketidfont{редактор} --- вложенный документ;}
 @item{@racketidfont{максимальная-ширина}, @racketidfont{минимальная-ширина},
  @racketidfont{максимальная-высота}, @racketidfont{минимальная-высота}
  --- ограничения размера ячейки (чтение и запись). При записи можно
  передать вторым аргументом, менять ли те же пределы у вложенного
  редактора (по умолчанию да).}
]}

@defthing[#:kind "класс" список-стилей% любой]{
Список именованных стилей документа. Модуль
@racketidfont{графический-интерфейс/стиль}. Создаётся без аргументов.

@itemlist[
 @item{@racketidfont{базовый-стиль} --- корневой стиль списка;}
 @item{@racketidfont{найти-по-имени} --- стиль с этим именем или
  @racketvalfont{ложь};}
 @item{@racketidfont{новый-с-именем} --- зарегистрировать копию стиля
  под именем; если имя занято, возвращает уже существующий стиль;}
 @item{@racketidfont{заменить-с-именем} --- подменить стиль с этим именем
  или создать новый, если имени ещё нет.}
]}

@defthing[#:kind "класс" стиль% любой]{
Стиль начертания куска. Тот же модуль. Обычно получают из списка стилей,
а не создают пустым.

@itemlist[
 @item{@racketidfont{базовый-стиль} --- стиль, от которого унаследован
  этот, или @racketvalfont{ложь};}
 @item{@racketidfont{установить-отклонение} --- применить
  @racket[отклонение-стиля%] к этому стилю.}
]}
...
@defthing[#:kind "класс" отклонение-стиля% любой]{
Отличие стиля от базового при @racketidfont{изменить-стиль}. Создаётся
без аргументов (пустое отклонение).

@itemlist[
 @item{@racketidfont{установить-цвет-текста} --- цвет букв
  (@racket[цвет%] или символ из @racket[стандартные-цвета]);}
 @item{@racketidfont{установить-цвет-фона} --- цвет фона участка.}
]}

@defthing[#:kind "класс" набор-команд% любой]{
Привязки клавиш редактора. Модуль
@racketidfont{графический-интерфейс/набор-команд}.

Аргумент @racketidfont{внутренний} --- готовый набор; иначе создаётся
пустой.

@itemlist[
 @item{@racketidfont{добавить-функцию} --- имя и функция; функция
  получает источник события и само событие;}
 @item{@racketidfont{есть-функция?} --- зарегистрировано ли имя;}
 @item{@racketidfont{вызвать-функцию} --- имя, источник и событие;}
 @item{@racketidfont{функция-команды} --- привязать последовательность
  клавиш (строка команды) к имени функции;}
 @item{@racketidfont{отменить-последовательность} --- сбросить набор
  частично введённой последовательности клавиш.}
]}
