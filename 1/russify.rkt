...
(define (русифицировать-вывод строка)
 ...
 с нереализованными методами")
     ...
     ("lambda: bad syntax" . "функция: неправильный синтаксис")
     ("функция: bad syntax" . "функция: неправильный синтаксис")
     ("for: expected a sequence for" . "цикл: ожидалась последовательность для")
     ("expected a sequence for" . "ожидалась последовательность для")
     ("got something else:" . "получено что-то другое:")
     ("for:" . "цикл:")
