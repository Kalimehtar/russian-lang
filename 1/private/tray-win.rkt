...
(define (make-tray-finalizer nid uid owned-box shown-box)
  (λ (_)
...
(define tray%
  (class object%
    ...
    (register-finalizer this
                        (make-tray-finalizer nid uid owned-box shown-box))
