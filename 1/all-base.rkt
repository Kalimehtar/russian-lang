...
(defnames список список? пара пара? длина-строки подстрока логический? добавить-строки корень
  ...
  функция символ? символ->строка строка->символ точное-число? неточное-число? неточное->точное
  точное->неточное синус косинус тангенс арксинус арккосинус арктангенс логарифм экспонента)